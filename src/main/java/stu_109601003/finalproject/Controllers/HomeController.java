...
public class HomeController implements EventHandler<MouseEvent> {
    ...
    public void chestHandle(MouseEvent event) {
        try {
            Image image = new Image(
                    new FileInputStream("./src/main/resources/stu_109601003/finalproject/imgs/parts/chest.jpg"));
    ...
    public void legHandle(MouseEvent event) {
        try {
            Image image = new Image(new FileInputStream("./src/main/resources/stu_109601003/finalproject/imgs/parts/leg.jpg"));
            ImageView imageView = new ImageView(image);
            imageView.setFitWidth(400);
            imageView.setFitHeight(219);
            imageView.setY(50);
    ...
    public void backHandle(MouseEvent event) {
        try {
            Image image = new Image(new FileInputStream("./src/main/resources/stu_109601003/finalproject/imgs/parts/back.jpg"));
            ImageView imageView = new ImageView(image);
            imageView.setFitWidth(400);
    ...
    public void shoulderHandle(MouseEvent event) {
        try {
            Image image = new Image(new FileInputStream("./src/main/resources/stu_109601003/finalproject/imgs/parts/shoulder.jpg"));
            ImageView imageView = new ImageView(image);
            imageView.setFitWidth(400);
            imageView.setFitHeight(490);
            imageView.setY(0);
    ...
    public void armHandle(MouseEvent event) {
        try {
            Image image = new Image(new FileInputStream("./src/main/resources/stu_109601003/finalproject/imgs/parts/arm.jpg"));
            ImageView imageView = new ImageView(image);
            imageView.setFitWidth(400);
    ...
    public void coreHandle(MouseEvent event) {
        try {
            Image image = new Image(new FileInputStream("./src/main/resources/stu_109601003/finalproject/imgs/parts/core.jpg"));
            ImageView imageView = new ImageView(image);
            imageView.setFitWidth(400);
    ...
    public void aerobicHandle(MouseEvent event) {
        try {
            Image image = new Image(new FileInputStream("./src/main/resources/stu_109601003/finalproject/imgs/parts/aero.jpg"));
            ImageView imageView = new ImageView(image);
            imageView.setFitWidth(400);
            ...
            if (machine.getSelectionModel().selectedItemProperty().getValue().equals(machineAction[i])) {
                try {
                    Image image = new Image(new FileInputStream(
                            "./image/gif/" + machineActionEnglish[i] + ".gif"));
                    ImageView imageView = new ImageView(image);
                    imageView.setFitWidth(400);
                    imageView.setY(50);
