...
public class ShoulderHandler extends MusclePartHandler {
    ...
    private String imagePath = "./src/main/resources/final_project/imgs/parts/shoulder.jpg";
